...
const (
	Orders_GetOrdersByUserId_FullMethodName = "/orders.Orders/GetOrdersByUserId"
)
...
func (c *ordersClient) GetOrdersByUserId(ctx context.Context, in *GetOrdersByUserIdRequest, opts ...grpc.CallOption) (*GetOrdersByUserIdResponse, error) {
	out := new(GetOrdersByUserIdResponse)
	err := c.cc.Invoke(ctx, Orders_GetOrdersByUserId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrdersServer) GetOrdersByUserId(context.Context, *GetOrdersByUserIdRequest) (*GetOrdersByUserIdResponse, error) {
...
func _Orders_GetOrdersByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrdersByUserIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrdersServer).GetOrdersByUserId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Orders_GetOrdersByUserId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServer).GetOrdersByUserId(ctx, req.(*GetOrdersByUserIdRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Orders_GetOrdersByUserId_Handler,
		},
	},
